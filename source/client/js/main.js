    ...
    with(processingInstance) {
        ...
        var mapCamera = {
            ...
            run() {
                ...
                this.right = -world.width;
                this.bottom = -world.height;
        ...
        var minimap = {
            ...
            run() {
                ...
                if(myNum !== undefined) {
                    this.ax = 115 * players[myNum].x / world.width;
                    this.ay = 115 * players[myNum].y / world.height;
                }
                stroke(100);
                strokeWeight(5);
        ...
        draw = () => {
            ...
            if(players[myNum].playing) {
                ...
                strokeWeight(0.5);
                if(!hideGrid) {
                    for (var w = -width * 2; w < world.width + width * 2; w += 22.5) line(w, -width * 2, w, world.width * 2);
                    for (var h = -height * 2; h < world.height + height * 2; h += 22.5) line(-height * 2, h, world.height * 2, h);
                }
                strokeWeight(3);
                stroke(191,174,80);
                fill(colors.square);
